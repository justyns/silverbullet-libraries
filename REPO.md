...
Libraries created and shared by me. 

You can add this repo by using the `Library: Add Repository` command and adding `https://github.com/justyns/silverbullet-libraries/blob/master/REPO.md`.


```#meta/library/remote
name: Get GPS Coords
description: lua function to get the current gps coordinates of the client browser
